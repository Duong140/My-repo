...
//There are 10 usernames/password combinations
//There is only 1 logic = Login
//you have to determined which combinations are not working/working for the same logic
...
//4. You have to parameterize the Test Case

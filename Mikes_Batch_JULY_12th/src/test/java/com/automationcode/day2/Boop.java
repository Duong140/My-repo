...
public class Boop {
	...
	public static Object[][] readDataFromExcelSheet() throws Exception {
		Object[][] data = Boop.readFromExcelSheetTutorialsNinja("LoginTN");
		return data;
	...
	public static Object[][] readFromExcelSheetRediff() throws Exception {
		Object[][] data = Boop.readFromExcelSheetTutorialsNinja("LoginRediff");
		return data;
	...
	public static Object[][] readFromExcelSheetTutorialsNinja(String sheetName) throws Exception {
		...
		ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\com\\automationcode\\day2\\ExcelDataCode.xlsx");

...
public class HowToReadFromExcel {
	...
	public static Object[][] readFromExcelSheetTutorialsNinja(String sheetName) throws Exception {
		...
		ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\com\\automation_22_Aug_2023DataDrivenTesting\\ExcelDataCode.xlsx");
		...
		int cols = sheet.getRow(0).getLastCellNum(); //num of cols

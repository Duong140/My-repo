...
public class Selection_Conditional_Control_Statements {
	...
	public static void main(String[] args) {
		...
		if(i<j && i<k && i<l && i<m) {
			...
			System.out.println("j is the smallesy :" + j);
		...
		if((year1%400 == 0) || (year1%4 == 0 && year1%100 != 0)) {
			...
			System.out.println("year1 - 1996 is not leap year");
		}
		
		if((year2%400 == 0) || (year2%4 == 0 && year2%100 != 0)) {
			System.out.println("year2 - 1900 is a leap year");
		}else {
			System.out.println("year2 - 1900 is not leap year");
		}
		...
		if((year3%400 == 0) || (year3%4 == 0 && year3%100 != 0)) {
			...
			System.out.println("year3 - 2000 is not leap year");
		}
